...
9. Если нужно export картинку с тектом, то текст нужно перевести в кривые
    с помощью ctr + 8. Для того чтобы пользователь у которого нет такого 
    шрифта мог в хорошо увидеть. 


10. Комментарии
    Использовать в HTML и CSS комментарии блоков


11. Чтобы создавать многостраничные сайты нужно в главный файл index.html
    с помощью @include('cart.html') импортировать другие страницы и скрипты

12. Соблюдение порядка написания css свойств

13. Методология BEM

14. Картинки - image. Картинки для разных блоков нужно разносить
        по разным папкам

15. Для каждой новой секции нужно писать id
